...
public interface IReplaceRule extends ICommon{
    ...
    String REG_COL_REPL_ATOM = PLACE_HOLDER + "(" + REG_NUM_NATURAL + ")\\.(0|" + REG_NUM_NATURAL + ")" + PLACE_HOLDER;
    String REG_COL_REPL_COMP = PLACE_HOLDER + "(" + REG_NUM_NATURAL + ")" + FLAG_COL_REPL_COMP + "(" + REG_NUM_NATURAL + ")\\.?(" + REG_NUM_NATURAL + ")?" + PLACE_HOLDER;
