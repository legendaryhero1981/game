...
public interface IFileUtil extends ICommon{
    ...
    + "file -f" + OPTIONS + "|-fd" + OPTIONS + "|-fdo" + OPTIONS + "|-fpa" + OPTIONS + "|-fpr" + OPTIONS + "|-fps" + OPTIONS + "|-fpda" + OPTIONS + "|-fpdr" + OPTIONS + "|-fpds" + OPTIONS + "|-fpdoa" + OPTIONS + "|-fpdor" + OPTIONS + "|-fpdos" + OPTIONS + "|-fs" + OPTIONS + "|-fsa" + OPTIONS + "|-fsd" + OPTIONS + "|-fds" + OPTIONS + "|-fdsa" + OPTIONS + "|-fdsd" + OPTIONS + "|-fdosa" + OPTIONS + "|-fdosd" + OPTIONS + "|-fddsa" + OPTIONS + "|-fddsd" + OPTIONS + "|-r" + OPTIONS + "|-rl" + OPTIONS + "|-ru" + OPTIONS + "|-ruf" + OPTIONS + "|-rd" + OPTIONS + "|-rdl" + OPTIONS + "|-rdu" + OPTIONS + "|-rduf" + OPTIONS + "|-c" + OPTIONS + "|-cd" + OPTIONS + "|-d" + OPTIONS + "|-dd" + OPTIONS + "|-ddn" + OPTIONS + "|-m" + OPTIONS + "|-md" + OPTIONS + "|-b" + OPTIONS + "|-bd" + OPTIONS + "|-bu" + OPTIONS + "|-br" + OPTIONS + "|-u" + OPTIONS + "|-ud" + OPTIONS + "|-zd" + OPTIONS + "|-zdd" + OPTIONS + "|-zi" + OPTIONS + "|-pd" + OPTIONS + "|-pdd" + OPTIONS + "|-pi" + OPTIONS + " regex src [dest] [backup] [sizeExpr] [replacement] [limit] [zipName] [zipLevel] [level]" + gl(2)    + "命令参数：" + gl(2)
    ...
    + "单条命令：" + gl(2)
    + "file -f" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件。" + gl(2)
    + "file -fd" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件和子目录及其中所有文件，相对-f增加了目录名匹配，若目录名匹配，则该目录中所有文件和子目录都自动被匹配。" + gl(2)
    + "file -fdo" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的目录。" + gl(2)
    + "file -fpa" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件（同-f），显示文件的绝对路径名。" + gl(2)
    + "file -fpr" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件（同-f），显示文件的相对路径名（不包含src目录名称）。" + gl(2)
    + "file -fps" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件（同-f），显示文件的相对路径名（包含src目录名称）。" + gl(2)
    + "file -fpda" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件和子目录及其中所有文件（同-fd），显示文件或子目录的绝对路径名。" + gl(2)
    + "file -fpdr" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件和子目录及其中所有文件（同-fd），显示文件或子目录的相对路径名（不包含src目录名称）。" + gl(2)
    + "file -fpds" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的文件和子目录及其中所有文件（同-fd），显示文件或子目录的相对路径名（包含src目录名称）。" + gl(2)
    + "file -fpdoa" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的子目录（同-fdo），显示子目录的绝对路径名。" + gl(2)
    + "file -fpdor" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的子目录（同-fdo），显示子目录的相对路径名（不包含src目录名称）。" + gl(2)
    + "file -fpdos" + OPTIONS + " regex src [limit] [level]" + gl(1) + "根据regex查找src中的子目录（同-fdo），显示子目录的相对路径名（包含src目录名称）。" + gl(2)
    + "file -fs" + OPTIONS + " regex src [sizeExpr] [limit] [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件。" + gl(2)
    + "file -fsa" + OPTIONS + " regex src [sizeExpr] [limit] [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件，按文件大小递增排序。" + gl(2)
    + "file -fsd" + OPTIONS + " regex src [sizeExpr] [limit] [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件，按文件大小递减排序。" + gl(2)
    + "file -fds" + OPTIONS + " regex src [sizeExpr] [limit] [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件和子目录；若匹配到目录，则其中所有文件只需匹配sizeExpr；也适用于-fdsa和-fdsd。" + gl(2)
    + "file -fdsa" + OPTIONS + " regex src [sizeExpr] [limit] [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件和子目录，按文件大小递增排序。" + gl(2)
    + "file -fdsd" + OPTIONS + " regex src [sizeExpr] [limit] [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件和子目录，按文件大小递减排序。" + gl(2)
    + "file -fdosa" + OPTIONS + " regex src [sizeExpr] [limit]" + gl(1) + "根据regex和sizeExpr查找src中的第一级子目录，按子目录大小递增排序。" + gl(2)
    + "file -fdosd" + OPTIONS + " regex src [sizeExpr] [limit]" + gl(1) + "根据regex和sizeExpr查找src中的第一级子目录，按子目录大小递减排序。" + gl(2)
    + "file -fddsa" + OPTIONS + " regex src [sizeExpr] [limit]" + gl(1) + "根据regex和sizeExpr查找src中的文件和第一级子目录，按子文件或目录大小递增排序。" + gl(2)
    + "file -fddsd" + OPTIONS + " regex src [sizeExpr] [limit]" + gl(1) + "根据regex和sizeExpr查找src中的文件和第一级子目录，按子文件或目录大小递减排序。" + gl(2)
    + "file -d" + OPTIONS + " regex src [level]" + gl(1) + "根据regex删除src中所有匹配文件。" + gl(2)
    + "file -dd" + OPTIONS + " regex src [level]" + gl(1) + "根据regex删除src中所有匹配文件和子目录及其中所有文件。" + gl(2)
    + "file -ddn" + OPTIONS + " regex src [level]" + gl(1) + "根据regex删除src中所有匹配的空文件和空目录。" + gl(2)
    + "file -r" + OPTIONS + " regex src replacement [level]" + gl(1) + "根据regex和replacement重命名src中的文件。" + gl(2)
    + "file -rl" + OPTIONS + " regex src [level]" + gl(1) + "根据regex将src中所有匹配文件名中英文字母替换为小写；regex可最多指定9个捕获组，最左边为第1个捕获组，程序只会替换捕获组中的子串，如：(.*\\.)txt$ 表示只替换文件名，不会替换扩展名txt；.*\\.txt$则文件名和扩展名都会被替换；也适用于-ru和-ruf。" + gl(2)
    + "file -ru" + OPTIONS + " regex src [level]" + gl(1) + "根据regex将src中所有匹配文件名中英文字母替换为大写。" + gl(2)
    + "file -ruf" + OPTIONS + " regex src [level]" + gl(1) + "根据regex将src中所有匹配文件名中英文单词首字母替换为大写。" + gl(2)
    + "file -rd" + OPTIONS + " regex src replacement [level]" + gl(1) + "根据regex和replacement重命名src中的文件和子目录。" + gl(2)
    + "file -rdl" + OPTIONS + " regex src [level]" + gl(1) + "根据regex将src中所有匹配文件名和目录名中英文字母替换为小写；regex可最多指定9个捕获组，最左边为第1个捕获组，程序只会替换捕获组中的子串，如：(.*\\.)txt$ 表示只替换文件名，不会替换扩展名txt；.*\\.txt$则文件名和扩展名都会被替换；也适用于-rdu和-rduf。" + gl(2)
    + "file -rdu" + OPTIONS + " regex src [level]" + gl(1) + "根据regex将src中所有匹配文件名和目录名中英文字母替换为大写。" + gl(2)
    + "file -rduf" + OPTIONS + " regex src [level]" + gl(1) + "根据regex将src中所有匹配文件名和目录名中英文单词首字母替换为大写。" + gl(2)
    + "file -c" + OPTIONS + " regex src dest [level]" + gl(1) + "根据regex复制src中文件到dest中。" + gl(2)
    + "file -cd" + OPTIONS + " regex src dest [level]" + gl(1) + "根据regex复制src中所有匹配文件和子目录及其中所有文件到dest中。" + gl(2)
    + "file -m" + OPTIONS + " regex src dest [level]" + gl(1) + "根据regex移动src中文件到dest中。" + gl(2)
    + "file -md" + OPTIONS + " regex src dest [level]" + gl(1) + "根据regex移动src中所有匹配文件和子目录及其中所有文件到dest中。" + gl(2)
    + "file -b" + OPTIONS + " regex src dest backup [level]" + gl(1) + "根据regex获得src中所有匹配文件，检查这些文件在dest中是否存在，将不存在的文件备份到backup中。" + gl(2)
    + "file -bd" + OPTIONS + " regex src dest backup [level]" + gl(1) + "根据regex获得src中所有匹配文件和子目录及其中所有文件，检查这些文件和子目录在dest中是否存在，将不存在的文件和子目录备份到backup中。" + gl(2)
    + "file -bu" + OPTIONS + " regex src dest backup [level]" + gl(1) + "根据regex获得src中所有匹配文件，检查这些文件在dest中是否能找到文件名称是以该文件名称为前缀的文件，若存在则先将dest中匹配的文件移动到backup中，再将该文件移动到dest中。" + gl(2)
    + "file -br" + OPTIONS + " regex src dest backup [level]" + gl(1) + "根据regex获得src中所有匹配文件，检查这些文件在dest中是否能找到文件名称是该文件名称的前缀的文件，若存在则先将dest中匹配的文件移动到backup中，再将该文件移动到dest中。" + gl(2)
    + "file -u" + OPTIONS + " regex src dest backup [level]" + gl(1) + "根据regex将src中所有匹配文件更新到dest中，更新时会先检查dest中是否已存在该文件，若存在则先将该文件备份到backup中，再更新之。" + gl(2)
    + "file -ud" + OPTIONS + " regex src dest backup [level]" + gl(1) + "根据regex将src中所有匹配文件和子目录及其中所有文件更新到dest中，更新时会先检查dest中是否已存在该文件，若存在则先将该文件备份到backup中，再更新之。" + gl(2)
    + "file -zd" + OPTIONS + " regex src dest zipName [zipLevel] [level]" + gl(1) + "根据regex将src中所有匹配文件压缩到dest/zipName" + EXT_ZIP + "文件中。" + gl(2)
    + "file -zdd" + OPTIONS + " regex src dest zipName [zipLevel] [level]" + gl(1) + "根据regex将src中所有匹配文件和子目录及其中所有文件压缩到dest/zipName" + EXT_ZIP + "文件中。" + gl(2)
    + "file -zi" + OPTIONS + " regex src dest [level]" + gl(1) + "根据regex将src中所有匹配文件解压缩到dest中。" + gl(2)
    + "file -pd" + OPTIONS + " regex src dest zipName [zipLevel] [level]" + gl(1) + "根据regex将src中所有匹配文件打包到dest/zipName" + EXT_PAK + "文件中。" + gl(2)
    + "file -pdd" + OPTIONS + " regex src dest zipName [zipLevel] [level]" + gl(1) + "根据regex将src中所有匹配文件和子目录及其中所有文件打包到dest/zipName" + EXT_PAK + "文件中。" + gl(2)
    + "file -pi" + OPTIONS + " regex src [level]" + gl(1) + "根据regex将src中所有匹配文件解包到该文件所在目录中。" + gl(2)
    + "单条命令示例：" + gl(2)
