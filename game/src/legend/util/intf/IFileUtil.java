...
public interface IFileUtil extends IReplaceRule{
    ...
    + ADD_INT + "(group" + SPRT_ARGS + "variable)" + gs(8) + "group为query中指定的捕获组编号，取值范围为0~9；variable为整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value += variable后再将value返回并替换旧值。" + gl(2)
    + ADD_LONG + "(group" + SPRT_ARGS + "variable)" + gs(7) + "group为query中指定的捕获组编号，取值范围为0~9；variable为长整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value += variable后再将value返回并替换旧值。" + gl(2)
    + ADD_FLOAT + "(group" + SPRT_ARGS + "variable)" + gs(6) + "group为query中指定的捕获组编号，取值范围为0~9；variable为单精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value += variable后再将value返回并替换旧值。" + gl(2)
    + ADD_DOUBLE + "(group" + SPRT_ARGS + "variable)" + gs(5) + "group为query中指定的捕获组编号，取值范围为0~9；variable为双精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value += variable后再将value返回并替换旧值。" + gl(2)
    + SUB_INT + "(group" + SPRT_ARGS + "variable)" + gs(8) + "group为query中指定的捕获组编号，取值范围为0~9；variable为整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value -= variable后再将value返回并替换旧值。" + gl(2)
    + SUB_LONG + "(group" + SPRT_ARGS + "variable)" + gs(7) + "group为query中指定的捕获组编号，取值范围为0~9；variable为长整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value -= variable后再将value返回并替换旧值。" + gl(2)
    + SUB_FLOAT + "(group" + SPRT_ARGS + "variable)" + gs(6) + "group为query中指定的捕获组编号，取值范围为0~9；variable为单精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value -= variable后再将value返回并替换旧值。" + gl(2)
    + SUB_DOUBLE + "(group" + SPRT_ARGS + "variable)" + gs(5) + "group为query中指定的捕获组编号，取值范围为0~9；variable为双精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value -= variable后再将value返回并替换旧值。" + gl(2)
    + MUL_INT + "(group" + SPRT_ARGS + "variable)" + gs(8) + "group为query中指定的捕获组编号，取值范围为0~9；variable为整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value *= variable后再将value返回并替换旧值。" + gl(2)
    + MUL_LONG + "(group" + SPRT_ARGS + "variable)" + gs(7) + "group为query中指定的捕获组编号，取值范围为0~9；variable为长整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value *= variable后再将value返回并替换旧值。" + gl(2)
    + MUL_FLOAT + "(group" + SPRT_ARGS + "variable)" + gs(6) + "group为query中指定的捕获组编号，取值范围为0~9；variable为单精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value *= variable后再将value返回并替换旧值。" + gl(2)
    + MUL_DOUBLE + "(group" + SPRT_ARGS + "variable)" + gs(5) + "group为query中指定的捕获组编号，取值范围为0~9；variable为双精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value *= variable后再将value返回并替换旧值。" + gl(2)
    + DIV_INT + "(group" + SPRT_ARGS + "variable)" + gs(8) + "group为query中指定的捕获组编号，取值范围为0~9；variable为整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value /= variable后再将value返回并替换旧值。" + gl(2)
    + DIV_LONG + "(group" + SPRT_ARGS + "variable)" + gs(7) + "group为query中指定的捕获组编号，取值范围为0~9；variable为长整型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value /= variable后再将value返回并替换旧值。" + gl(2)
    + DIV_FLOAT + "(group" + SPRT_ARGS + "variable)" + gs(6) + "group为query中指定的捕获组编号，取值范围为0~9；variable为单精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value /= variable后再将value返回并替换旧值。" + gl(2)
    + DIV_DOUBLE + "(group" + SPRT_ARGS + "variable)" + gs(5) + "group为query中指定的捕获组编号，取值范围为0~9；variable为双精度浮点型变量，设捕获组group对应的数值为value，则执行此方法等效于执行value /= variable后再将value返回并替换旧值。" + gl(2)
