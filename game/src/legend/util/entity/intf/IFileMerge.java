...
public interface IFileMerge extends IFileUtil{
    ...
    String N_MEG_NODE = "path或path2或path3或mergeExecutablePath或queryRegex节点";
    String ST_FILE_MERGE_CONF = V_GNRT + N_MEG_CONF + S_DQM + CONF_FILE_MERGE + S_DQM + S_BANG;
    String ERR_MEG_NODE_NON = N_MEG_CONF + S_DQM_L + PH_ARGS0 + S_DQM_R + N_IN + N_MEG_NODE + V_BY_NUL + S_BANG;
