...
public interface IFileMerge extends IFileUtil{
    ...
    String ERR_CONF_MEG_NON = N_MEG_CONF + S_DQM_L + PH_ARG0 + S_DQM_R + V_NON_EXISTS;
    String ERR_CONF_MEG_NODE_NON = N_MEG_CONF + S_DQM_L + PH_ARG0 + S_DQM_R + N_IN + N_MEG_NON + V_BY_NUL;
