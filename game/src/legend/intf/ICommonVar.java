...
public interface ICommonVar{
    ...
    + "file -f[+*@?]|-fd[+*@?]|-fdo[+*@?]|-fs[+*@?]|-fds[+*@?]|-fsa[+*@?]|-fdsa[+*@?]|-fsd[+*@?]|-fdsd[+*@?]|-r[+*@?]|-rd[+*@?]|-rl[+*@?]|-rdl[+*@?]|-ru[+*@?]|-rdu[+*@?]|-ruf[+*@?]|-rduf[+*@?]|-c[+*@?]|-cd[+*@?]|-d[+*@?]|-dd[+*@?]|-ddn[+*@?]|-m[+*@?]|-md[+*@?]|-b[+*@?]|-bd[+*@?]|-bu[+*@?]|-br[+*@?]|-u[+*@?]|-ud[+*@?]|-zd[+*@?]|-zdd[+*@?]|-zi[+*@?]|-pd[+*@?]|-pdd[+*@?]|-pi[+*@?] regex [sizeExpr] [replacement] src [dest] [backup] [zipName] [zipLevel] [level]" + gl(2)
    + "命令参数：" + gl(2)
    ...
    + "单条命令：" + gl(2)
    + "file -f[+*@?] regex src [level]" + gl(1) + "根据regex查找src中的文件。" + gl(2)
    + "file -fd[+*@?] regex src [level]" + gl(1) + "根据regex查找src中的文件和目录及其中所有文件，相对-f增加了目录名匹配，若目录名匹配，则该目录下所有文件和子目录都自动被匹配。" + gl(2)
    + "file -fdo[+*@?] regex src [level]" + gl(1) + "根据regex查找src中的目录。" + gl(2)
    + "file -fs[+*@?] regex sizeExpr src [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件。" + gl(2)
    + "file -fds[+*@?] regex sizeExpr src [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件和目录；若匹配到目录，则其中所有文件只需匹配sizeExpr；也适用于-fdsa和-fdsd。" + gl(2)
    + "file -fsa[+*@?] regex sizeExpr src [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件，按文件大小递增排序。" + gl(2)
    + "file -fdsa[+*@?] regex sizeExpr src [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件和目录，按文件大小递增排序。" + gl(2)
    + "file -fsd[+*@?] regex sizeExpr src [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件，按文件大小递减排序。" + gl(2)
    + "file -fdsd[+*@?] regex sizeExpr src [level]" + gl(1) + "根据regex和sizeExpr查找src中的文件和目录，按文件大小递减排序。" + gl(2)
    + "file -d[+*@?] regex src [level]" + gl(1) + "根据regex删除src中所有匹配文件。" + gl(2)
    + "file -dd[+*@?] regex src [level]" + gl(1) + "根据regex删除src中所有匹配文件和目录及其中所有文件。" + gl(2)
    ...
    + "file -rd[+*@?] regex replacement src [level]" + gl(1) + "根据regex和replacement重命名src中的文件和目录。" + gl(2)
    ...
    + "file -cd[+*@?] regex src dest [level]" + gl(1) + "根据regex复制src中所有匹配文件和目录及其中所有文件到dest中。" + gl(2)
    + "file -m[+*@?] regex src dest [level]" + gl(1) + "根据regex移动src中文件到dest中。" + gl(2)
    + "file -md[+*@?] regex src dest [level]" + gl(1) + "根据regex移动src中所有匹配文件和目录及其中所有文件到dest中。" + gl(2)
    + "file -b[+*@?] regex src dest backup [level]" + gl(1) + "根据regex获得src中所有匹配文件，检查这些文件在dest中是否存在，将不存在的文件备份到backup中。" + gl(2)
    + "file -bd[+*@?] regex src dest backup [level]" + gl(1) + "根据regex获得src中所有匹配文件和目录及其中所有文件，检查这些文件和目录在dest中是否存在，将不存在的文件和目录备份到backup中。" + gl(2)
    ...
    + "file -ud[+*@?] regex src dest backup [level]" + gl(1) + "根据regex将src中所有匹配文件和目录及其中所有文件更新到dest中，更新时会先检查dest中是否已存在该文件，若存在则先将该文件备份到backup中，再更新之。" + gl(2)
    + "file -zd[+*@?] regex src dest zipName [zipLevel] [level]" + gl(1) + "根据regex将src中所有匹配文件压缩到dest/zipName" + EXT_ZIP + "文件中。" + gl(2)
    + "file -zdd[+*@?] regex src dest zipName [zipLevel] [level]" + gl(1) + "根据regex将src中所有匹配文件和目录及其中所有文件压缩到dest/zipName" + EXT_ZIP + "文件中。" + gl(2)
    ...
    + "file -pdd[+*@?] regex src dest zipName [level]" + gl(1) + "根据regex将src中所有匹配文件和目录及其中所有文件打包到dest/zipName" + EXT_PAK + "文件中。" + gl(2)
    + "file -pi[+*@?] regex src [level]" + gl(1) + "根据regex将src中所有匹配文件解包到该文件所在目录中。" + gl(2)
    + "单条命令示例：" + gl(2)
    + "file -f+ (?i)_cn(\\..{0,2}strings$) \"F:/games/Fallout 4/Data/Strings\"" + gl(1) + "查询该目录下名称以_cn.strings（忽略大小写）结尾的所有文件，.与strings中间可以包含0到2个任意字符。" + gl(2)
    + "file -fd+ (?i)strings$ \"F:/games/Fallout 4\"" + gl(1) + "查询该目录下名称以strings（忽略大小写）结尾的所有文件和目录及其中所有文件。" + gl(2)
    + "file -fdo+ . \"F:/games/KingdomComeDeliverance/修改/Mods\" 1" + gl(1) + "查询该目录下的第一级子目录。" + gl(2)
    + "file -fs+ . 1MB-1GB \"F:/games/FINAL FANTASY XV\"" + gl(1) + "查询该目录下大小介于1兆字节到1千兆字节之间的所有文件。" + gl(2)
    + "file -fds+ \\Ajp$ 1MB-1GB \"F:/games/FINAL FANTASY XV\"" + gl(1) + "查询该目录下所有子目录名为jp的目录中大小介于1兆字节到1千兆字节之间的所有文件。" + gl(2)
    ...
    + "file -dd \"\\Ade$|\\Afr$|\\Aru$|\\Aus$\" \"F:/games/FINAL FANTASY XV\"" + gl(1) + "先查询（作用同-fd）再删除该目录中所有匹配文件和目录及其中所有文件。" + gl(2)
    ...
    + "file -cd (?i).{0,2}strings$ \"F:/games/Fallout 4/Data\" \"F:/games/Fallout 4/备份\"" + gl(1) + "先查询（作用同-fd）再将 .../Data 中所有匹配文件和目录及其中所有文件复制到 .../备份 目录中。" + gl(2)
    ...
    + "file -md (?i).{0,2}strings$ \"F:/games/Fallout 4/Data\" \"F:/games/Fallout 4/备份\"" + gl(1) + "先查询（作用同-fd）再将 .../Data 中所有匹配文件和目录及其中所有文件移动到 .../备份 目录中。" + gl(2)
    ...
    + "file -bd \\Adatas$ \"F:/games/FINAL FANTASY XV\" \"F:/迅雷下载/FINAL FANTASY XV\" \"F:/备份\"" + gl(1) + "先查询（作用同-fd）获得 F:/games/FINAL FANTASY XV 目录中所有匹配文件和目录及其中所有文件，检查这些文件和目录在 F:/迅雷下载/FINAL FANTASY XV 目录中是否存在，将不存在的文件和目录备份到 F:/备份 目录中。" + gl(2)
    ...
    + "file -ud \\Adatas$ \"F:/games/FINAL FANTASY XV\" \"F:/迅雷下载/FINAL FANTASY XV\" \"F:/备份\"" + gl(1) + "先查询（作用同-fd）再将 F:/games/FINAL FANTASY XV 目录中所有匹配文件和目录及其中所有文件更新到 F:/迅雷下载/FINAL FANTASY XV 中，若存在同名文件则先将该文件备份到 F:/备份 目录中，再更新之。" + gl(2)
    ...
    + "file -zdd (?i).{0,2}strings$ \"F:/games/Fallout 4/Data\" \"F:/games/Fallout 4/备份\" strings 1" + gl(1) + "先查询（作用同-fd）再将 .../Data 目录中所有匹配文件和目录及其中所有文件按压缩级别1压缩到 .../备份/strings" + EXT_ZIP + " 文件中。" + gl(2)
    ...
    + "file -pdd . \"F:/games/KingdomComeDeliverance/修改/Merge/Data\" \"F:/games/KingdomComeDeliverance/Mods/Merge/Data\" merge" + gl(1) + "先查询（作用同-fd）再将 .../修改/Merge/Data 目录中所有匹配文件和目录及其中所有文件打包到 .../Mods/Merge/Data/merge" + EXT_PAK + " 文件中。" + gl(2)
    ...
    + "-mu\t\t\t先清空modPath目录，再重新解包该目录下所有Mod。" + gl(2)
    + "-mmf\t\t\t重新整合modPath目录下所有Mod，并重新合并所有冲突文件（即多个Mod共有的同名文件）。" + gl(2)
    + "-mma\t\t\t重新整合modPath目录下所有Mod，只重新合并变化了的冲突文件（即同名文件有更新、新增或删除）。" + gl(2)
    ...
    + "-mmu\t\t\t在mergePath目录下重新生成Mod配置文件" + KCD_FILE_CONFIG + "中配置的所有唯一文件（即非冲突文件），并更新这些文件的MD5码。" + gl(2)
